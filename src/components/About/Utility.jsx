...
const Utility = () => {
  ...
  const titulo_path = new URL(
    "../../assets/documents/052-223998.pdf",
    import.meta.url
  ).pathname;
  ...
  const downloadTitulo = () => {
    setLoadCV(true);
    // Creamos un elemento de enlace
    const link = document.createElement("a");
    // Establecemos la ruta del archivo
    link.href = titulo_path;
    // Establecemos el atributo de descarga con el nombre deseado del archivo
    link.download = "052-223998.pdf";
    // Ocultamos el enlace
    link.style.display = "none";
    // Añadimos el enlace al cuerpo del documento
    document.body.appendChild(link);
  ...
  return (
    <section className="m-[0_auto] w-[85%] sm:w-[70%] md:w-[50%] mt-5 mb-10">
